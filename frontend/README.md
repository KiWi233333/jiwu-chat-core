...
JiwuChat 是一款基于 Tauri2 和 Nuxt3 构建的轻量`(~10MB)`多平台聊天应用，具备多种实时消息能力，支持无缝跨设备通信，涵盖文本、图片、文件和语音等多种消息，还支持群聊和可定制化设置。提供浅色/深色模式，助力高效社交。✨
...
| 通知系统   | 消息通知   | 桌面通知、系统托盘提醒、消息免打扰                                      | ✅       |
| 扩展功能   | 综合集成   | 博客集成、悦读时光、更新日志面板                                        | ✅       |
| 其他模块   | 其他功能   | 聊天社交功能、文件下载管理、翻译工具（AI翻译/腾讯翻译）功能             | ✅       |
