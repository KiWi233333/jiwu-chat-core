 ...
 * 充值套餐参数类
 *
 * @className: UpdateRechargeComboDTO
 * @author: Kiwi23333
 * @description: UpdateRechargeComboDTO
 * @date: 2023/5/5 14:40
 */
@Data
@AllArgsConstructor
...
public class UpdateRechargeComboDTO {
    ...
    @Schema(description = "送积分额度")
    @Max(value = 10000, message = "积分额度不能高于10000积分！")
    private Long points;

    public static RechargeCombo toRechargeCombo(UpdateRechargeComboDTO re) {
