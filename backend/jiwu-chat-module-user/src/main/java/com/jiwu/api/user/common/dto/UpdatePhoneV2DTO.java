 ...
 */
@Data
public class UpdatePhoneV2DTO {


    @Schema(description = "旧手机号", requiredMode = Schema.RequiredMode.REQUIRED)
    @Phone(message = "旧手机号格式错误！")
    @NotBlank(message = "旧手机号不能为空！")
    private String oldPhone;

    @Schema(description = "旧手机-验证码", requiredMode = Schema.RequiredMode.REQUIRED)
